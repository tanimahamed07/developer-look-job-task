    ...
    <section className="relative w-full px-6 pt-2 md:pt-16 md:pb-20 bg-[#F9F6F0] overflow-hidden">
      <div className="max-w-[1400px] mx-auto text-left">
        ...
        <div className="hidden md:flex mx-12 flex-nowrap items-center justify-center py-12 gap-0 group">
          {[0, 1, 2, 3].map((idx) => (
            ...
            >
              {idx === 0 && (
                <>
                  <h2 className="text-[75px] leading-tight font-extrabold tracking-tight">
                    10M+
                  </h2>
              ...
              {idx === 2 && (
                <>
                  <h2 className="text-[75px] leading-tight font-extrabold tracking-tight text-black">
                    30+
                  </h2>
                  <div className="space-y-3">
                    <p className="font-extrabold text-[24px] text-black">
        ...
        <div className="flex md:hidden relative h-[420px] mt-8 items-center justify-center">
          ...
          {/* Card 2 (Video Card) - Bro kora hoyeche */}
          <div className="absolute right-[5%] top-4 z-20 w-[215px] h-[290px] bg-gray-200 rounded-[30px] overflow-hidden shadow-2xl rotate-[3deg]">
            <video
              src={bannerVedio}
              autoPlay
              loop
