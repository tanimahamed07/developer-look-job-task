...
const IntroSection = () => {
  return (
    <section className="w-full bg-[#F9F6F0] px-6 pt-20 pb-32 mb-30 md:mb-0 overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Bottom Row */}
        <div className="mt-12 md:mt-18 flex flex-col md:flex-row items-start gap-10 md:gap-24">
          
          {/* Media Container */}
          <div className="w-full md:w-[235px] md:h-[313px] flex-shrink-0 flex justify-center md:justify-start">
            
            {/* Video: Mobile version with Tilt (Baka) */}
            <div className="block md:hidden w-full max-w-[300px] rotate-2"> {/* -rotate-2 added tilt */}
              <video
            ...
            {/* Image: Desktop version (No change) */}
          ...
          <div className="flex flex-col md:mt-20 md:ml-33 w-full">
            <p className="text-[18px] md:text-[24px] text-[#1D1D1F] leading-[1.4] font-bold tracking-tight">
              ...
              Zo weet je precies what werkt en wat niet.<br className="hidden md:block" /> 
              Nooit meer content zonder strategie.<br className="hidden md:block" />
              Nooit meer content zonder resultaat.
            </p>

            {/* Button: Fixed width for mobile to match design */}
            <div className="mt-8 md:mt-10 flex justify-start">
              <button className="group flex items-center justify-between gap-4 border border-[#1D1D1F] rounded-xl pl-6 pr-2 py-2 text-[16px] font-bold text-[#1D1D1F] hover:bg-[#1D1D1F] hover:text-white transition-all duration-300 min-w-[200px] md:min-w-0">
                Leer ons kennen
                <span className="w-9 h-6 bg-[#1D1D1F] text-white rounded-xl flex items-center justify-center group-hover:bg-white group-hover:text-[#1D1D1F] transition-colors">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 24 24"
